...
public class RepayMCDCCoverageTest {
    @Test
    public void card_invaild_and_name_vaild_and_money_vaild_and_istotal_and_great_pay() {
        boolean card= false;
        boolean  name=true;
    ...
    @Test
    public void card_vaild_and_name_invaild_and_money_vaild_and_istotal_and_lower_pay() {
        boolean card= true;
        boolean  name=false;
    ...
    @Test
    public  void card_vaild_and_name_vaild_and_money_invaild_and_istotal_and_lower_pay() {
        boolean card= true;
        boolean  name=true;
    ...
    @Test
    public  void card_vaild_and_name_vaild_and_money_vaild_and_ispart_and_great_pay() {
        boolean card= true;
        boolean  name=true;
        BigDecimal money= new BigDecimal(80);
        BigDecimal pay= new BigDecimal(50);
        boolean total=false;
        boolean part=true;
        Repay cm=new Repay(card,name,money,total,part,pay);
        String actual_result=cm.doRepay();
    ...
    @Test
    public void card_vaild_and_name_vaild_and_money_vaild_and_no_and_great_pay() {
        boolean card= true;
        boolean  name=true;
        BigDecimal money= new BigDecimal(80);
        BigDecimal pay= new BigDecimal(50);
